...
## State Management
- [Overview](https://flutter.dev/docs/development/data-and-backend/state-mgmt/simple)
- [Streams](https://dart.dev/tutorials/language/streams)
- [Provider package](https://pub.dev/packages/provider)
  - [Using provider for state management](https://medium.com/flutter-community/flutter-pragmatic-state-management-using-provider-5c1129f9b5bb)
- [Bloc/Cubit package](https://pub.dev/packages/bloc)
